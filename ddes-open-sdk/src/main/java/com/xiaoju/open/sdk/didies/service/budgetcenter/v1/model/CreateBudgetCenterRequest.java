...
@NoArgsConstructor
@AllArgsConstructor
public class CreateBudgetCenterRequest extends BaseReq  {
    ...
    /**
     * 主管ID，人员同步时返回的memberid leader_id和leader_employee_id 时，优先处理leader_id，多个用英文逗号分开，第一个是主要主管，后续是其他主管，最多30个
     * 
     */
    ...
    /**
     * 上级部门/项目 ID，新建部门时返回的部门ID，type &#x3D; 1 非必填，传0为顶级部门ID，type&#x3D;2 默认为，parent_id优先级大于 out_parent_id和 out_parent_name
     * 
     */
    @JsonProperty("parent_id")
    private String parentId;
    /**
     * 上级部门/项目外部CODE，type &#x3D; 1 非必填，不传默认为顶级部门code，type&#x3D;2 默认为空，项目需要out_parent_id和out_parent_name一起传递，作为唯一值校验。
     * 
     */
    ...
    /**
     * 公司主体ID，多个用英文逗号分开，字段不传不生效，如果对应的公司主体id已经停用或者不存在 返回错误码10001 type&#x3D;2时生效
     * 
     */
    @JsonProperty("legal_entity_id")
    private String legalEntityId;
    /**
     * 项目扩展信息的自定义字段，项目扩展信息的自定义字段；最长不大于 500 字符；(必须为json字符串，json解析后不能为空)；非必填，仅对项目（type&#x3D;2）生效，部门传了不生效
     * 
     */
