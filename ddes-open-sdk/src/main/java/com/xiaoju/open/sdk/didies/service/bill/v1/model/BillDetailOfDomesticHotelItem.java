...
@NoArgsConstructor
@AllArgsConstructor
public class BillDetailOfDomesticHotelItem  {
    ...
    private Long billId;
    /**
     * 结算时间 格式：\&quot;yyyy-MM-dd HH:mm:ss\&quot; 入账时间（交易维度，支付或者退款）
     * 
     */
    ...
    /**
     * 房费总价&#x3D;企业支付房费+个人金额+券金额
     * 
     */
    @JsonProperty("cost_discount_before")
    private BigDecimal costDiscountBefore;
    /**
     * 订单金额（平台使用费同步收：订单金额&#x3D;房费总价+平台使用费+差额费 平台使用费异步收：订单金额&#x3D;房费总价）
     * 
     */
    @JsonProperty("amount")
