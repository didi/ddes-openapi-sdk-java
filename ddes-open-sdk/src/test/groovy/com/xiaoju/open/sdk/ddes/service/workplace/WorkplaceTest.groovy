...
import com.xiaoju.open.sdk.didies.service.workplace.v1.model.CreateWorkplaceApiReply
import com.xiaoju.open.sdk.didies.service.workplace.v1.model.CreateWorkplaceRequest
import com.xiaoju.open.sdk.didies.service.workplace.v1.model.DeleteWorkplaceApiReply
import com.xiaoju.open.sdk.didies.service.workplace.v1.model.DeleteWorkplaceRequest
import com.xiaoju.open.sdk.didies.service.workplace.v1.model.UpdateWorkplaceApiReply
import com.xiaoju.open.sdk.didies.service.workplace.v1.model.UpdateWorkplaceRequest
...
/**
 * API tests for Workplace
 */
class WorkplaceTest extends Specification {

    private Workplace api

    def setup() {
        Config config = new Config()
        ApiClient client = new ApiClient(config)
        api = client.workplace()
    }
    ...
    def createWorkplaceTest() {
        CreateWorkplaceRequest createWorkplaceRequest = new CreateWorkplaceRequest()

        println(JacksonUtils.toJson(createWorkplaceRequest))
    ...
    def deleteWorkplaceTest() {
        DeleteWorkplaceRequest deleteWorkplaceRequest = new DeleteWorkplaceRequest()

        println(JacksonUtils.toJson(deleteWorkplaceRequest))
    ...
    def updateWorkplaceTest() {
        UpdateWorkplaceRequest updateWorkplaceRequest = new UpdateWorkplaceRequest()

        println(JacksonUtils.toJson(updateWorkplaceRequest))
